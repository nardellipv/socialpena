<aside class="sidebar static">
    <div class="widget">
        ...
        <div class="your-page">
            <figure>
                <a href="#" title=""><img src="{{ asset('styleWeb/images/resources/friend-avatar9.jpg')}}" alt=""></a>
            </figure>
            <div class="page-meta">
                    ...
                    <span><i class="ti-heart"></i>884</span>
                      ...
                      <div class="users-thumb-list">
                        <a href="#" title="Anderw" data-toggle="tooltip">
                            <img src="{{ asset('styleWeb/images/resources/userlist-1.jpg')}}" alt="">  
                        </a>
                        <a href="#" title="frank" data-toggle="tooltip">
                            <img src="{{ asset('styleWeb/images/resources/userlist-2.jpg')}}" alt="">  
                        </a>
                        <a href="#" title="Sara" data-toggle="tooltip">
                            <img src="{{ asset('styleWeb/images/resources/userlist-3.jpg')}}" alt="">  
                        </a>
                        <a href="#" title="Amy" data-toggle="tooltip">
                            <img src="{{ asset('styleWeb/images/resources/userlist-4.jpg')}}" alt="">  
                        </a>
                        <a href="#" title="Ema" data-toggle="tooltip">
                            <img src="{{ asset('styleWeb/images/resources/userlist-5.jpg')}}" alt="">  
                        </a>
                        <a href="#" title="Sophie" data-toggle="tooltip">
                            <img src="{{ asset('styleWeb/images/resources/userlist-6.jpg')}}" alt="">  
                        </a>
                        <a href="#" title="Maria" data-toggle="tooltip">
                            <img src="{{ asset('styleWeb/images/resources/userlist-7.jpg')}}" alt="">  
                        </a>  
                      </div>
                  </div>
    ...
    <div class="widget">
        <div class="banner medium-opacity bluesh">
            ...
            <div class="baner-top">
                <span><img alt="" src="{{ asset('styleWeb/images/book-icon.png')}}"></span>
    ...
    <div class="widget friend-list stick-widget">
        ...
        <ul id="people-list" class="friendz-list">
            <li>
                <figure>
                    <img src="{{ asset('styleWeb/images/resources/friend-avatar.jpg')}}" alt="">
            ...
            <li>
                <figure>
                    <img src="{{ asset('styleWeb/images/resources/friend-avatar2.jpg')}}" alt="">
            ...
            <li>
                <figure>
                    <img src="{{ asset('styleWeb/images/resources/friend-avatar3.jpg')}}" alt="">
            ...
            <li>
                <figure>
                    <img src="{{ asset('styleWeb/images/resources/friend-avatar4.jpg')}}" alt="">
                    <span class="status f-off"></span>
                </figure>
                <div class="friendz-meta">
            ...
            <li>
                ...
                <figure>
                    <img src="{{ asset('styleWeb/images/resources/friend-avatar5.jpg')}}" alt="">
                    <span class="status f-online"></span>
                </figure>
                <div class="friendz-meta">
            ...
            <li>
                ...
                <figure>
                    <img src="{{ asset('styleWeb/images/resources/friend-avatar6.jpg')}}" alt="">
                    <span class="status f-away"></span>
                </figure>
                <div class="friendz-meta">
            ...
            <li>
                ...
                <figure>
                    <img src="{{ asset('styleWeb/images/resources/friend-avatar7.jpg')}}" alt="">
                    <span class="status f-off"></span>
                </figure>
                <div class="friendz-meta">
        ...
        <div class="chat-box">
            ...
            <div class="chat-list">
                <ul>
                    <li class="me">
                        <div class="chat-thumb"><img src="{{ asset('styleWeb/images/resources/chatlist1.jpg')}}" alt=""></div>
                    ...
                    <li class="you">
                        <div class="chat-thumb"><img src="{{ asset('styleWeb/images/resources/chatlist2.jpg')}}" alt=""></div>
                        <div class="notification-event">
                            <span class="chat-message-item">
                                Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the gifts and Jake’s gonna get the drinks
                            </span>
