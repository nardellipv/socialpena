        ...
        <div class="central-meta">
            <div class="about">
                <div class="personal">
                    ...
                    @else
                        <p><b>{{ $user->nickname }}</b> todavía no escribe en su perfil</p>
                    @endif
                </div>
                <div class="d-flex flex-row mt-2">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="basic" role="tabpanel">
                            <div>                                                                
                                ...
                                <li><i class="ti-map-alt"></i>
                                    {{ !empty($user->profile->province->name) ? $user->profile->province->name : $user->name . ' todavía no completa su ubicación' }}
                                </li>
                                <li><i
                        ...
                        <div class="tab-pane fade" id="writting" role="tabpanel">
                            <textarea name="message-socio" placeholder="{{ $user->nickname }} recibirá un email con tu mensaje"
                                rows="5"></textarea>
